...
```json
{
  ...
  "actions": [
    { "name": "pin-course", "method": "PUT", "fields": [{ "name": "pinned", "type": "hidden", "value": true }] }
  ]
}
```
...
```json
{
  "class": ["named-entity", "describable-entity", "draft-published-entity", "published", "active", "course-offering"],
  "properties": {
...
```json
{
  ...
  "entities": [{ "class": ["icon", "tier1"], "rel": ["icon"], "properties": { "iconSetKey": "tier1:file-document" } }]
}
```
...
```json
{
  ...
  "entities": [
    { "class": ["richtext"], "rel": ["item"], "properties": { "text": "...", "html": "<p>...</p>" } },
    {
